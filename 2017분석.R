...
raw_welfare <- read.spss(file = "Koweps_hpda12_2017_beta1.sav", to.data.frame = T)
welfare <- raw_welfare
...
# 변수명 바꾸기 
welfare <- rename(welfare, sex = h12_g3, # 성별 
                  birth = h12_g4, # 태어난 연도 
                  marriage = h12_g10, # 혼인 상태 
                  religion = h12_g11, # 종교 
                  income = p1202_8aq1, # 월급 
                  code_job = h12_eco9, # 직종 코드 
                  code_region = h12_reg7) # 지역 코드
